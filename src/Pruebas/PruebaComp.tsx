...
export const PruebaComp = () => {
    ...
    return (
        ...
        <Menu/>
        <div>
            <Preguntas respuesta = "NAN" imagen = "https://i.postimg.cc/TwHpXcHv/255b0a44-343d-43c2-b323-4ef339aab3d2.jpg"/>
        </div>
        <div>
        ...
        <div>
            <Preguntas respuesta = "4" imagen = "https://i.postimg.cc/HxCgKvgh/2969ac91-558f-43ac-adff-732e09a7b276.jpg"/>
        </div>
        </>
