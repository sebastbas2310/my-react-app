...
Uno a uno [OneToOne]: Un objeto está asociado con otro único objeto.
Uno a muchos [OneToMany]: Un objeto se relaciona con varios otros (ejemplo: un profesor con varios estudiantes).
Muchos a muchos[ManyToMany]: Varios objetos de una clase pueden estar relacionados con varios objetos de otra (ejemplo: estudiantes y cursos).
